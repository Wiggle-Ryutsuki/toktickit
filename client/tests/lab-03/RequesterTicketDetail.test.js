...
describe("Requester Ticket Detail & Resolution Indication (UI-08)", () => {
    ...
    function renderRequesterDetail(ticketId = 101) {
        return render(_jsx(AuthContext.Provider, { value: mockContext, children: _jsx(RequesterProvider, { children: _jsx(RequesterTicketDetail, { ticketId: ticketId, onBack: mockOnBack }) }) }));
    }
