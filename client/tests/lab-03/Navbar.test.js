...
describe("Navbar Component (UI-03)", () => {
    ...
    function renderNavbar(user) {
        ...
        return render(_jsx(AuthContext.Provider, { value: mockContext, children: _jsx(RequesterProvider, { children: _jsx(Navbar, {}) }) }));
    }
    ...
    it("UI-03.5: Opens profile dropdown, displays full email, and allows navigating to change-password", () => {
        ...
        render(_jsx(AuthContext.Provider, { value: mockContext, children: _jsx(RequesterProvider, { children: _jsx(Navbar, { onNavigate: mockNavigate }) }) }));
