...
describe("ChangePassword Component (UI-02)", () => {
    ...
    function renderChangePassword(contextValue = mockContext) {
        return render(_jsx(AuthContext.Provider, { value: contextValue, children: _jsx(ChangePassword, {}) }));
    }
    ...
    it("UI-02.5: Submitting valid form calls changePassword API with all fields", async () => {
        ...
        await waitFor(() => {
            expect(mockChangePassword).toHaveBeenCalledWith("InitialPass123!", "NewPassword456#", "NewPassword456#");
        });
    });
